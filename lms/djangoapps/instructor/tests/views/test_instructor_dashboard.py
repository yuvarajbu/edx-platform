...
class TestInstructorDashboard(ModuleStoreTestCase, LoginEnrollmentTestCase, XssTestMixin):
    ...
    def test_no_enrollments(self):
        ...
        self.assertNotIn('<h3 id="header-course_info" class="hd hd-3">Enrollment Information</h3>', response.content)
    ...
    def test_show_enrollments_data(self):
        ...
        self.assertIn('<h3 id="header-course_info" class="hd hd-3">Enrollment Information</h3>', response.content)
