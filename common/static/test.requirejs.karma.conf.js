...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            // include those vendor js files who needs <script> tag
            ...
            // include common/js|templates but don't add a <script> tag for each
        ...
        preprocessors: {
            // don't include spec files in coverage
            'common/js/!(spec|spec_helpers)/**/*.js': ['coverage']
        },
